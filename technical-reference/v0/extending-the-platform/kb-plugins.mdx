...
A datahub source is any custom file source that can be imported into a datahub. A datahub source converts your source into files. An example source is reading from a SQL database and writing the data as text to a file.
