...
description: "Here you can manage your Knowledge Bases."
# todo:
...
<CardGroup cols={2}>
  <Card title="Entity Knowledge Bases" icon="database">
    Permanent Knowledge Bases that are managed in the Knowledge Bases section
    and can be referenced by multiple agents or workflows.
  </Card>
