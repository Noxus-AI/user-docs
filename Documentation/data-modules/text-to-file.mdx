...
The `Text to File` module is a data module that can convert text and images into a file. Currently there is no way to style this document.
...
The `Text to File` module has **variable inputs** and **one output**:

- **Input**:
  - Inputs can be of type `text` and `image`; you can add them in any specific to structure the document as you see fit
- **Output**:
  - `File`, the output is of a file type in the specified format
