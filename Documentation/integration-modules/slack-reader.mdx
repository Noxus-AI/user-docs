...
> **Note: This module is particularly useful if you want to build an agent for your Slack. It ensures that all the historical messages are given as context.** > **To build a Slack agent you should use a slack trigger, in order to activate the workflow on every message**
...
- **Config**:
  ...
  - **Number of messages read**: Number of historical messages to read in the Slack channel
